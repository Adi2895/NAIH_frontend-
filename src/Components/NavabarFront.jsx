  ...
  <div className="home-container">
    <div className="home-header">
          <header data-thq="thq-navbar" className="home-navbar-interactive">
            <span className="home-logo">NAIH</span>
            {/* <div> */}
            ...
            <div data-thq="thq-mobile-menu" className="home-mobile-menu">
              <div className="home-nav">
                <div className="home-top">
                  <span className="home-logo1">NAIH</span>
          ...
          <div className="home-hero1">
            <div className="home-container01">
              <p className="home-hero-heading heading1">
                National Academic 
              </p>
              <p className="home-hero-heading heading1">
              Innovation Hub
              </p>
              <small className="home-hero-sub-heading">
                Organizing and showcasing student projects from across India
              </small>
